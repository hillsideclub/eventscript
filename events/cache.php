...
require_once('../events/_includes/simplepie.inc');
require_once('../events/_includes/simplepie-gcalendar.php');
...
$markup = file_get_contents('../events/_includes/partial.html');
$output = '';
